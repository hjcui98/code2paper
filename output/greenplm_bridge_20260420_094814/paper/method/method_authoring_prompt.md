...
```json
{
  ...
  "stages": [
    {
      ...
      "mechanisms": [
        {
          "mechanism_id": "MECH1",
          "description": "Mechanism 1 for Stage I: Text-First Interface Warmup.",
    ...
    },
    {
      ...
      "outputs": [
        "instruction_tuned_projector"
      ],
      "modules": [],
      "mechanisms": [
        {
          "mechanism_id": "MECH2",
          "description": "Mechanism 1 for Stage II: Rich Instruction Alignment.",
          "support_status": "supported",
          "evidence_ids": [
            "E1795"
          ],
    ...
    },
    {
      ...
      "mechanisms": [
        {
          "mechanism_id": "MECH3",
          "description": "Mechanism 1 for Stage III: Point-Language Transfer.",
          "support_status": "supported",
          "evidence_ids": [
            "E1795"
          ],
  ...
  "frozen_mechanisms": [
    {
      ...
      "mechanism_description": "Establish projector-language coupling under mostly frozen backbone settings. The model learns to align text descriptions with the projector while keeping the point encoder and LLM frozen.",
      "parent_stage_id": "S1",
      "inputs": [
        "['text_descriptions', 'point_placeholders']"
      ],
      "outputs": [
        "['aligned_projector_weights']"
      ],
    ...
    },
    {
      ...
      "mechanism_description": "Expand from simple descriptions to richer instruction/dialog patterns while preserving projector continuity. Maintains the frozen backbone constraint but introduces complex conversational data.",
      "parent_stage_id": "S2",
      "inputs": [
        "['instruction_dialogs', 'qa_pairs']"
      ],
      "outputs": [
        "['instruction_tuned_projector']"
      ],
    ...
    },
    {
      ...
      "mechanism_description": "Use point-cloud token features and compact token aggregation to transfer prior alignment to 3D inputs. Unfreezes or partially unfreezes the point encoder to enable end-to-end 3D-language alignment.",
      "parent_stage_id": "S3",
      "inputs": [
        "['raw_point_clouds', 'conversation_supervision']"
      ],
      "outputs": [
        "['multimodal_representations', '3d_grounded_text']"
      ],
      "implementation_anchor": {
        "path": "",
        "symbols": []
  ...
  "claim_contracts": [
    ...
    },
    {
      ...
      "required_qualifiers": [
        "partially supported by discovered evidence"
      ],
      "review_question_id": "RQ-4"
    },
    {
      "claim_id": "C5",
      "claim_intent": "Establish projector-language coupling under mostly frozen backbone settings. The model learns to align text descriptions with the projector while keeping the point encoder and LLM frozen.",
      "support_status": "supported",
      "evidence_span_ids": [
        "E3622",
        "E3622",
    ...
    {
      "claim_id": "C6",
      "claim_intent": "Expand from simple descriptions to richer instruction/dialog patterns while preserving projector continuity. Maintains the frozen backbone constraint but introduces complex conversational data.",
      "support_status": "supported",
      "evidence_span_ids": [
        "E1795"
      ],
    ...
    {
      "claim_id": "C7",
      "claim_intent": "Use point-cloud token features and compact token aggregation to transfer prior alignment to 3D inputs. Unfreezes or partially unfreezes the point encoder to enable end-to-end 3D-language alignment.",
      "support_status": "supported",
      "evidence_span_ids": [
        "E1795"
      ],
...
```json
{
  "claims": [
    {
      "claim_id": "C1",
      "claim_text": "Mechanism 1 for Stage I: Text-First Interface Warmup.",
      "support_status": "supported",
      "evidence_ids": [
        "E3622"
      ],
    ...
    {
      "claim_id": "C2",
      "claim_text": "Mechanism 1 for Stage II: Rich Instruction Alignment.",
      "support_status": "supported",
      "evidence_ids": [
        "E1795"
      ],
    ...
    {
      "claim_id": "C3",
      "claim_text": "Mechanism 1 for Stage III: Point-Language Transfer.",
      "support_status": "supported",
      "evidence_ids": [
        "E1795"
      ],
    ...
    {
      "claim_id": "C22",
      "claim_text": "Establish projector-language coupling under mostly frozen backbone settings. The model learns to align text descriptions with the projector while keeping the point encoder and LLM frozen.",
      "support_status": "supported",
      "evidence_ids": [
        "E3622",
        "E3622",
    ...
    {
      "claim_id": "C23",
      "claim_text": "Expand from simple descriptions to richer instruction/dialog patterns while preserving projector continuity. Maintains the frozen backbone constraint but introduces complex conversational data.",
      "support_status": "supported",
      "evidence_ids": [
        "E1795"
      ],
    ...
    {
      "claim_id": "C24",
      "claim_text": "Use point-cloud token features and compact token aggregation to transfer prior alignment to 3D inputs. Unfreezes or partially unfreezes the point encoder to enable end-to-end 3D-language alignment.",
      "support_status": "supported",
      "evidence_ids": [
        "E1795"
      ],
