...
```json
{
  ...
  "stages": [
    {
      ...
      "mechanisms": [
        {
          "mechanism_id": "MECH0101",
          "description": "Recovered mechanism 1 for input_preparation.",
    ...
    },
    {
      ...
      "mechanisms": [
        {
          "mechanism_id": "MECH0201",
          "description": "Recovered mechanism 1 for transformer_computation.",
          "support_status": "supported",
          "evidence_ids": [
            "E75",
            "E78",
    ...
    },
    {
      ...
      "mechanisms": [
        {
          "mechanism_id": "MECH0301",
          "description": "Recovered mechanism 1 for scheduled_optimization.",
          "support_status": "supported",
          "evidence_ids": [
            "E1657",
            "E2279"
  ...
  "frozen_mechanisms": [
    {
      ...
      "author_claim_relation": "ambiguous_due_to_missing_context",
      "evidence_span_ids": []
    },
    {
      "mechanism_id": "MECH2",
    ...
    {
      "mechanism_id": "MECH0101",
      "mechanism_name": "input_preparation",
      "mechanism_description": "Prepare tokenized and serialized data for training.",
      "parent_stage_id": "S1",
      "inputs": [
    ...
    {
      "mechanism_id": "MECH0201",
      "mechanism_name": "transformer_computation",
      "mechanism_description": "Compute sequence representations through Transformer layers and sublayers.",
      "parent_stage_id": "S2",
      "inputs": [
        "input_ids",
        "point_clouds"
  ...
  "distinguishing_mechanisms": [
    "A compact local-to-global aggregation path is used before point features are conditioned into the LLM.",
    "Core novelty emphasis is stage design and modality-transfer strategy rather than replacing the base LLM backbone."
  ],
...
```json
{
  "claims": [
    {
      "claim_id": "C1",
      "claim_text": "Recovered mechanism 1 for input_preparation.",
      "support_status": "supported",
      "evidence_ids": [
        "E311",
        "E312",
    ...
    {
      "claim_id": "C2",
      "claim_text": "Recovered mechanism 1 for transformer_computation.",
      "support_status": "supported",
      "evidence_ids": [
        "E75",
        "E78",
    ...
    {
      "claim_id": "C3",
      "claim_text": "Recovered mechanism 1 for scheduled_optimization.",
      "support_status": "supported",
      "evidence_ids": [
        "E1657",
        "E2279"
