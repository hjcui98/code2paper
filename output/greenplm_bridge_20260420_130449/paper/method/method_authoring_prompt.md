...
```json
{
  ...
  "stages": [
      ...
      "mechanisms": [
        {
          ...
          "description": "Recovered mechanism 1 for Stage I: Text-First Interface Warmup.",
      ...
      "mechanisms": [
        {
          ...
          "description": "Recovered mechanism 1 for Stage II: Rich Instruction Alignment.",
          "support_status": "supported",
          "evidence_ids": [
            "E2490"
          ],
      ...
      "mechanisms": [
        {
          ...
          "description": "Recovered mechanism 1 for Stage III: Point-Language Transfer.",
          "support_status": "supported",
          "evidence_ids": [
            "E370",
            "E371",
    ...
    },
    {
      ...
      "mechanisms": [
        {
          "mechanism_id": "MECH0401",
          "description": "Recovered mechanism 1 for Runtime and saving behavior.",
          "support_status": "supported",
          "evidence_ids": [
            "E3355",
            "E3356",
...
```json
{
  "claims": [
    {
      "claim_id": "C1",
      "claim_text": "Recovered mechanism 1 for Stage I: Text-First Interface Warmup.",
      "support_status": "supported",
      "evidence_ids": [
        "E3622"
      ],
    ...
    {
      "claim_id": "C2",
      "claim_text": "Recovered mechanism 1 for Stage II: Rich Instruction Alignment.",
      "support_status": "supported",
      "evidence_ids": [
        "E2490"
      ],
    ...
    {
      "claim_id": "C3",
      "claim_text": "Recovered mechanism 1 for Stage III: Point-Language Transfer.",
      "support_status": "supported",
      "evidence_ids": [
        "E370",
        "E371",
    ...
    {
      "claim_id": "C4",
      "claim_text": "Recovered mechanism 1 for Runtime and saving behavior.",
      "support_status": "supported",
      "evidence_ids": [
        "E3355",
        "E3356",
