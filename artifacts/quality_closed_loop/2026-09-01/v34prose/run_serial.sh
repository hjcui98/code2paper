...
STAMP="20260901"
BASE="/tmp/c2p-v34prose-8006-${STAMP}"
LOG="${BASE}/serial.log"
cd "$ROOT"
export PYTHONUNBUFFERED=1
{
  echo "===== SERIAL START $(date -Iseconds) ====="
  echo "code_state_digest sha256:fbec291bb6234e199622867007dda04220856b1ce390496930b12ad5a3b5eb7f"
...
run_one() {
  ...
  local fresh="/tmp/c2p-v34prose-8006-${name}-${STAMP}"
  mkdir -p "$fresh"
...
run_one ebcar \
  ...
  "c2p-v34prose-8006-ebcar-20260901"
...
run_one dyg \
  ...
  "c2p-v34prose-8006-dyg-20260901"
...
run_one linearrag \
  ...
  "c2p-v34prose-8006-linearrag-20260901"
