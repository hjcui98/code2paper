...
def control_nodes() -> list[AgenticGraphNode]:
    return [
        ...
        AgenticGraphNode(
            ...
            output_artifacts=["figure_plan", "figure_plan_decision_trace", "evidence_relations_v2", "figure_scene", "figure_relation_validation", "pre_render_audit"],
            evidence_policy=EvidencePolicy.CONSUMES_FROZEN_EVIDENCE,
            allow_model_decision=True,
            hard_gate=True,
        ),
        ...
        AgenticGraphNode(
            name="final_invariant_audit",
            kind="audit",
            description="Re-run all evidence and rendered-asset invariants after post-render audit and before final packaging.",
            input_artifacts=["figure_scene", "method_overview_svg", "rendering_manifest", "post_render_audit"],
            output_artifacts=["final_invariant_audit"],
            evidence_policy=EvidencePolicy.VALIDATES_EVIDENCE,
            hard_gate=True,
        ),
        AgenticGraphNode(
