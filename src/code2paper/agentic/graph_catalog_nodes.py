...
def control_nodes() -> list[AgenticGraphNode]:
    return [
        ...
        AgenticGraphNode(
            name="local_text_repair",
            kind="repair",
            description="Apply exact-span wording/decomposition/drop repairs without regenerating unaffected Method text.",
            input_artifacts=["final_text_claims", "text_evidence_validation", "authoring_projection"],
            output_artifacts=["text_repair_issues_v1", "packet_repair_requests_v1"],
            evidence_policy=EvidencePolicy.VALIDATES_EVIDENCE,
            hard_gate=True,
        ),
        AgenticGraphNode(
            name="packet_binding_repair",
            kind="repair",
            description="Consume a typed packet-scoped repair request and fail closed instead of restarting global evidence or authoring stages.",
            input_artifacts=["packet_repair_requests_v1", "evidence_packets_v3"],
            output_artifacts=["packet_repair_requests_v1"],
            evidence_policy=EvidencePolicy.VALIDATES_EVIDENCE,
            hard_gate=True,
        ),
        AgenticGraphNode(
