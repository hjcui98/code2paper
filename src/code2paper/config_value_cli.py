"""CLI for config-value-to-text validation."""
...
from code2paper.validators.config_value_validator import validate_config_values_from_files


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="code2paper-config-values")
    ...
    report = validate_config_values_from_files(
