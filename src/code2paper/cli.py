...
from .pipeline.stage1_code_intake import run_stage1_code_intake
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--out", help="Write raw_evidence_pack.json to this path (optional convenience export).")
    parser.add_argument("--out-root", required=True, help="Write story-first Phase 1 artifacts under <out-root>/paper/method.")
    ...
    raw_pack, _comment_index, _raw_context_index, _context_map, paths = run_stage1_code_intake(
