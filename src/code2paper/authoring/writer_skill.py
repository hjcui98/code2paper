...
class PublicationMethodWriterSkillV1(BaseModel):
    ...
    def system_prompt(self) -> str:
        lines = [
            ...
            "When formula_packages is present, emit the supplied placeholder [[FORMULA:<package_id>]] in the owning paragraph beside the mechanism, explain its symbols at first use, and preserve every material_condition and assumption exactly. Do not type, copy, normalize, or alter a formula block; the harness inserts the stored display-math block verbatim. Candidate may consume author_intent_academic and hybrid_partial packages the same way; they remain ineligible for Verified.",
