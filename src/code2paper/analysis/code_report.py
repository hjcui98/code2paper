    ...
    *,
    ...
    phase2_code_report = {
        ...
        "phase3_input_contract": {
            "primary_artifact": "analysis.json",
            "supporting_artifacts": [
                "facts.json",
                "intake_alignment.json",
                "snippets.json",
                "code_graph.json",
            ],
    ...
    return {
        "author_summary": method_summary,
        "sources": code_sources,
        "snippets": core_snippets,
        "intake_alignment": method_code_alignment,
        "intake_report": code_intake_report,
        "facts": code_facts,
        "code_graph": code_ir,
        "entity_map": entity_links,
        "analysis_report": code_analysis_report,
