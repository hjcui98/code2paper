...
RESULT_ROOT="/data1/users/cuihengjia/result/batch_run_part_02_$(date +%Y%m%d_%H%M%S)"
...
/data1/users/cuihengjia/code2paper/code_raw/EDGS - Efficient 3D Gaussian Splatting	/data1/users/cuihengjia/code2paper/paperyaml/EDGS - Efficient 3D Gaussian Splatting.yaml
/data1/users/cuihengjia/code2paper/code_raw/EmoStyle - Emotion-Driven Image Stylization	/data1/users/cuihengjia/code2paper/paperyaml/EmoStyle - Emotion-Driven Image Stylization.yaml
...
echo
echo "batch_run_part_02 完成，汇总文件：$SUMMARY_FILE"
